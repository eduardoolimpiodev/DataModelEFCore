...
VALUES (N'20230113131949_Initial', N'2.2.6-servicing-10079');
...
CREATE TABLE [HeroisBatalhas] (
    ...
    [BatalhaId] int NOT NULL,
    [HeroiId] int NULL,
    CONSTRAINT [PK_HeroisBatalhas] PRIMARY KEY ([BatalhaId], [HeroId]),
    CONSTRAINT [FK_HeroisBatalhas_Batalhas_BatalhaId] FOREIGN KEY ([BatalhaId]) REFERENCES [Batalhas] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_HeroisBatalhas_Herois_HeroiId] FOREIGN KEY ([HeroiId]) REFERENCES [Herois] ([Id]) ON DELETE NO ACTION
);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20230113140832_HeroisBatalhas_Identidade', N'2.2.6-servicing-10079');
